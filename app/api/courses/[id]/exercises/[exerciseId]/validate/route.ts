...
export async function PATCH(
  ...
  try {
    ...
    const body = await req.json() as { difficulty?: unknown };
    const difficulty = typeof body.difficulty === "number" && [1, 2, 3].includes(body.difficulty)
      ? body.difficulty
      : null;
    ...
    console.error("[exercises/validate:PATCH]", err);
